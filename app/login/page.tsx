...
import { Lock, Mail, User as UserIcon, ShieldCheck, ArrowRight, Loader2 } from 'lucide-react';
    ...
    >
      ...
      >
        <div className="p-8 relative overflow-hidden backdrop-blur-2xl">
          ...
          {/* Divider & Google Sign-In / Sign-Up Button at the BOTTOM */}
          <div className="mt-5">
            <div className="relative my-4 flex items-center justify-center">
              <div className="border-t border-slate-800 w-full" />
              <span className="bg-[#080d1a] px-3 text-[10px] uppercase font-bold text-slate-400 absolute">or continue with</span>
            </div>
